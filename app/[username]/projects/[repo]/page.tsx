  ...
  useEffect(() => {
    const fetchRepoData = async () => {
      ...
      try {
        ...
        /*
        // Try fetching MyDevFolioXD.md with multiple variations
        ...
        const fileNameVariations = [
          ...
          'MyDevFolioXD.md',
          'MyDevFolioXD.md',
          'docs/MyDevFolioXD.md',
          'docs/MyDevFolioXD.md',
          '.github/MyDevFolioXD.md',
          '.github/MyDevFolioXD.md',
          'PROJECT.md',
          'project.md',
          'docs/PROJECT.md',
          ...
          <div className='mb-12'>
            <div className='flex justify-between items-center mb-4'>
              ...
              <div className='flex rounded-lg overflow-hidden border border-[var(--card-border)]'>
                ...
                {/* Commented out Project tab to disable MyDevFolioXD.md switch */}
                {/* <button
            ...
            <div className='card bg-[var(--card-bg)]'>
              <div className='flex items-center gap-2 px-4 py-2 border-b border-[var(--card-border)]'>
                ...
                <div className='ml-2 text-xs font-mono text-[var(--text-secondary)]'>
                  {viewMode === 'technical' ? 'README.md' : 'MyDevFolioXD.md'}
                </div>
              </div>
              <div className='p-6'>
                    ...
                    <div className='flex flex-col items-center justify-center py-8 text-[var(--text-secondary)]'>
                      ...
                      <p>
                        {viewMode === 'technical'
                          ...
                          : 'No MyDevFolioXD.md found for this repository.'}
                      </p>
                      {/* Commented out additional message for project mode */}
                      {/* {viewMode === 'project' && (
                        <p className='text-xs mt-2'>
                          Create a MyDevFolioXD.md file in your repository to
