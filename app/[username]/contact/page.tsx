    ...
    <>
      ...
      <div className='flex flex-col items-center pb-32 pt-12 relative'>
        ...
        >
          ...
          {/* Contact Form */}
          <motion.div
            className='w-full max-w-lg space-y-4 mt-8'
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
                  ...
                  <form onSubmit={handleFormSubmit} className='space-y-4'>
                    ...
                    <div>
                      <input
                        ...
                        className='w-full bg-[var(--card-bg)] border border-[var(--card-border)] text-[var(--text-primary)] px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent transition-all'
                        required
                      />
                    </div>
                    ...
                    <div>
                      <textarea
                        ...
                        rows={4}
                        className='w-full bg-[var(--card-bg)] border border-[var(--card-border)] text-[var(--text-primary)] px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent transition-all resize-none'
                        required
                      />
                    </div>
                    ...
                    <button
                      type='submit'
                      className='w-full bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-white px-6 py-3 rounded-md transition-colors font-medium'
                    >
                      Send Message
                    </button>
                  </form>
